import 'package:sreeLM/models/user.dart';
import 'package:sreeLM/pages/CreateAccountPage.dart';
import 'package:sreeLM/pages/ProfilePage.dart';
import 'package:sreeLM/pages/SearchPage.dart';
import 'package:sreeLM/pages/TimeLinePage.dart';
import 'package:sreeLM/pages/UploadPage.dart';
        ...
        body:Container(
            ...
            child:Column(
              ...
              children: <Widget>[
                Text(
                  "LocalifyMe",
                  style: TextStyle(fontSize: 122.0,color: Colors.white,fontFamily: "Signatra"),
                ),
                GestureDetector(
                  onTap: loginUser,
                  child: Container(
