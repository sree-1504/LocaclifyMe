...
import 'package:sreeLM/pages/HomePage.dart';
import 'package:sreeLM/widgets/ProgressWidget.dart';
...
updateUserData()
{
  ...
  if(_bioValid && _profileNameValid){
    ...
    SnackBar successSnackBar = SnackBar(content: Text("Profile has been successfully updated "));
  ...
  return Column(
   ...
   TextField(
     ...
     decoration: InputDecoration(
       hintText: "Write your profileName here!",
